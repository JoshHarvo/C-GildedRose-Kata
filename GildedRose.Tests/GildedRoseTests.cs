...
namespace GildedRose.Tests
{
    public class TestAssemblyTests
    {
        ...
        [InlineData("Backstage passes to a TAFKAL80ETC concert", 12, 20, 11, 21)]
        [InlineData("Backstage passes to a TAFKAL80ETC concert", 11, 20, 10, 22)]
        [InlineData("Backstage passes to a TAFKAL80ETC concert", 7, 20, 6, 22)]
        [InlineData("Backstage passes to a TAFKAL80ETC concert", 6, 20, 5, 23)]
        ...
        [InlineData("Aged Brie", -1, 40, -2, 42)]
